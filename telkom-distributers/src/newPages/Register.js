    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-50 p-4">
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-md">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <input type="text" name="fullName" placeholder="Full Name" value={form.fullName} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none" required />
