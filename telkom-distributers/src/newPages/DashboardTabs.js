    ...
    <div className="bg-white p-6 rounded-2xl shadow-sm text-gray-700">
      ...
      {activeTab === "Legal" && (
        <div>
          ...
          <p className="text-sm mb-2">{t("legalText") || "Key Regulations:"}</p>
      ...
      {activeTab === "Accessibility" && (
        <div>
          ...
          <p className="text-sm mb-2">{t("accessibilityText")}</p>
          <p className="text-sm">
            {t("contactSupport")}:{" "}
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {educationTips.map((tip, idx) => (
              <div
                key={idx}
                className="flex items-start p-3 mb-2 bg-gray-50 rounded-lg shadow-sm hover:bg-gray-100 transition cursor-pointer"
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {expandedTips.includes(idx) && <p className="text-xs text-gray-600 mt-1">{tip.details}</p>}
                </div>
              </div>
            ))}
          </div>
